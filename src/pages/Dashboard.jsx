...
//             <div>
//               <p className="text-gray-600 dark:text-gray-400 text-lg mb-2">Jami Foydalanuvchilar</p>
//               <p className="text-5xl font-bold text-indigo-600">{stats.userCount}</p>
//               <p className="text-sm text-gray-500 mt-2">Bugun: +{stats.todayUsers}</p>
//             </div>
//             <div className="bg-indigo-100 dark:bg-indigo-900/30 p-6 rounded-2xl">
...
//           <div className="flex items-center justify-between">
//             <div>
//               <p className="text-gray-600 dark:text-gray-400 text-lg mb-2">Jami Yangiliklar</p>
//               <p className="text-5xl font-bold text-purple-600">{stats.newsCount}</p>
//               <p className="text-sm text-gray-500 mt-2">Bugun: +{stats.todayNews}</p>
//             </div>
//             <div className="bg-purple-100 dark:bg-purple-900/30 p-6 rounded-2xl">
//               <svg className="w-12 h-12 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v8H7V8z" />
//               </svg>
//             </div>
//           </div>
//         </div>
...
//           <div className="flex items-center justify-between">
//             <div>
//               <p className="text-gray-600 dark:text-gray-400 text-lg mb-2">Oylik O'sish</p>
//               <p className={`text-5xl font-bold mt-4 ${stats.monthlyGrowth > 0 ? 'text-green-600' : 'text-red-600'}`}>
//                 {stats.monthlyGrowth > 0 ? '+' : ''}{stats.monthlyGrowth}%
//               </p>
//               <p className="text-sm text-gray-500 mt-2">O'tgan oyga nisbatan</p>
//             </div>
//             <div className={`p-6 rounded-2xl ${stats.monthlyGrowth > 0 ? 'bg-green-100 dark:bg-green-900/30' : 'bg-red-100 dark:bg-red-900/30'}`}>
//               <svg className={`w-12 h-12 ${stats.monthlyGrowth > 0 ? 'text-green-600' : 'text-red-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={stats.monthlyGrowth > 0 ? "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" : "M13 17h8m0 0v-8m0 8l-8-8-4 4-6-6"} />
//               </svg>
//             </div>
//           </div>
//         </div>
...
//           <div className="flex items-center justify-between">
//             <div>
//               <p className="text-gray-600 dark:text-gray-400 text-lg mb-2">Bugungi Faollik</p>
//               <p className="text-5xl font-bold text-orange-600">{stats.todayUsers + stats.todayNews}</p>
//               <p className="text-sm text-gray-500 mt-2">Yangi harakatlar</p>
//             </div>
...
//       {/* Mini chart – oxirgi 7 kun faolligi */}
//       <div className="card">
//         <h3 className="text-3xl font-bold mb-8 text-center">Oxirgi 7 kun faolligi</h3>
...
//           </h3>
//           {recentNews.length === 0 ? (
//             <p className="text-center text-xl text-gray-500 py-10">Hali yangilik yo'q</p>
//           ) : (
//             <div className="space-y-6">
//               {recentNews.map(item => (
//                 <div key={item._id} className="flex items-start gap-6 p-6 bg-gray-50 dark:bg-gray-700/50 rounded-2xl hover:shadow-lg transition">
//                   {item.image ? (
//                     <img src={`http://localhost:5000${item.image}`} alt="" className="w-20 h-20 object-cover rounded-xl" />
//                   ) : (
//                     <div className="w-20 h-20 bg-gradient-to-br from-indigo-400 to-purple-600 rounded-xl flex items-center justify-center text-white text-2xl font-bold">
//                       N
//                     </div>
//                   )}
//                   <div className="flex-1">
//                     <h4 className="text-xl font-semibold text-gray-800 dark:text-white line-clamp-1">
//                       {item.title}
//                     </h4>
...
//             <p className="text-center text-xl text-gray-500 py-10">Hali foydalanuvchi yo'q</p>
//           ) : (
//             <div className="space-y-6">
//               {recentUsers.map(user => (
//                 <div key={user._id} className="flex items-center gap-3 bg-gray-50 dark:bg-gray-700/50 rounded-2xl hover:shadow-lg transition">
//                   <div className="min-w-20 min-h-20 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-white text-xl font-bold shadow-xl">
...
//       {/* Motivatsiya xabari */}
//       <div className="text-center py-12 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl text-white">
//         <p className="text-4xl font-bold mb-4">Bugun ham ajoyib ish qiling!</p>
//         <p className="text-2xl opacity-90">Sizning panelingiz doimiy rivojlanmoqda 💪</p>
//       </div>
//     </div>
//   );
// };
